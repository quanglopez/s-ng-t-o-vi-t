  ...
  head: () => ({
    meta: [
      { title: "Vinrl — Workspace AI cho creator Việt" },
      {
        name: "description",
        content:
          "Lưu, phân tích và remix nội dung viral trên TikTok, Instagram, YouTube — tất cả trong một workspace dành cho creator và agency Việt Nam.",
      },
      { property: "og:title", content: "Vinrl — Workspace AI cho creator Việt" },
      {
        property: "og:description",
        content:
          "Biến mọi video viral thành công thức bạn có thể tái sử dụng. Voice profile riêng, lịch 30 ngày, remix AI bằng tiếng Việt.",
      },
    ],
  }),
  component: Index,
    ...
    <header className="sticky top-0 z-30 backdrop-blur bg-background/70 border-b border-border/60">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-7 text-sm text-muted-foreground">
          ...
          <a href="#cach-dung" className="hover:text-foreground">
            Cách dùng
          </a>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/dashboard">
            <Button size="sm" className="bg-gradient-brand text-white shadow-glow">
              Dùng thử 7 ngày
            </Button>
          </Link>
        </div>
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-28 text-center">
        ...
        <p className="mt-6 max-w-2xl mx-auto text-lg text-muted-foreground">
          Lưu mọi video viral, để AI bóc tách hook và cấu trúc, rồi remix lại bằng đúng giọng văn
          của bạn — toàn bộ bằng tiếng Việt.
        </p>
          ...
          <div className="rounded-3xl border border-border/60 bg-surface-elev shadow-glow overflow-hidden">
            <div className="flex items-center gap-1.5 px-4 py-3 border-b border-border/60 bg-surface">
              ...
              <span className="ml-3 text-xs text-muted-foreground">
                vinrl.app/boards/hook-viral-2026
              </span>
            </div>
            <div className="grid grid-cols-3 gap-3 p-4 bg-gradient-brand-soft">
              {posts.slice(0, 6).map((p) => (
                <div
                  key={p.id}
                  className="rounded-2xl overflow-hidden border border-border/40 bg-card text-left"
                >
                  <div
                    className={`aspect-[3/4] bg-gradient-to-br ${p.thumb} p-3 flex flex-col justify-between`}
                  >
                    <span className="text-[10px] font-bold text-white/90 bg-black/30 backdrop-blur w-fit px-2 py-0.5 rounded-full">
                      {p.platform}
                    </span>
    ...
    <section className="border-y border-border/60 bg-surface">
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="text-center text-xs uppercase tracking-widest text-muted-foreground mb-5">
          Được tin dùng bởi creator & agency
        </div>
  ...
  const items = [
    {
      icon: FolderHeart,
      title: "Bảng cảm hứng",
      desc: "Lưu video viral theo niche. Tag, ghi chú, chia sẻ với team agency.",
      color: "from-brand to-brand-2",
    },
    {
      icon: Sparkles,
      title: "AI bóc tách",
      desc: "Phân tích hook, angle, cấu trúc, CTA — kèm lý do vì sao video đó viral.",
      color: "from-brand-2 to-brand-3",
    },
    {
      icon: Mic,
      title: "Voice profile",
      desc: "Dạy AI cách bạn nói chuyện. Mọi caption sinh ra đều nghe như chính bạn.",
      color: "from-brand-3 to-brand-4",
    },
    {
      icon: Wand2,
      title: "Remix AI",
      desc: "Biến 1 video viral thành 10 phiên bản cho brand của bạn — tiếng Việt tự nhiên.",
      color: "from-brand-4 to-brand",
    },
    {
      icon: CalendarDays,
      title: "Lịch 30 ngày",
      desc: "AI dựng kế hoạch nội dung cả tháng, cân đối hook/story/sell.",
      color: "from-brand to-brand-3",
    },
    {
      icon: Zap,
      title: "Cho agency",
      desc: "Mời thành viên, gắn tag client, theo dõi ai đã duyệt nội dung nào.",
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="max-w-2xl">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mt-3">
            Mọi thứ một creator nghiêm túc cần — không hơn.
          </h2>
        </div>
        <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {items.map(({ icon: Icon, title, desc, color }) => (
            <div
              key={title}
              className="group rounded-2xl border border-border/60 bg-surface-elev p-6 hover:shadow-card transition"
            >
              <div
                className={`h-11 w-11 rounded-xl bg-gradient-to-br ${color} grid place-items-center shadow-glow`}
              >
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-wrap items-end justify-between gap-4 mb-10">
          <div>
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold mt-3">
              Tổ chức ý tưởng như studio thật sự.
            </h2>
          </div>
          <Link to="/boards">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {boards.slice(0, 6).map((b) => (
            <div
              key={b.id}
              className="rounded-2xl border border-border/60 bg-card p-5 hover:shadow-card transition"
            >
              <div
                className={`h-24 rounded-xl bg-gradient-to-br ${b.color} relative overflow-hidden`}
              >
  ...
  const steps = [
    {
      n: "01",
      t: "Lưu video viral",
      d: "Dán link TikTok hoặc Reels. Vinrl scrape caption, view, hook ngay lập tức.",
    },
    {
      n: "02",
      t: "AI bóc tách công thức",
      d: "Mỗi post được phân tích: hook, angle, cấu trúc, CTA, vì sao viral.",
    },
    {
      n: "03",
      t: "Remix bằng giọng bạn",
      d: "Voice profile + niche của bạn → caption mới sẵn sàng đăng.",
    },
  ];
  return (
    <section id="cach-dung" className="py-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <h2 className="font-display text-4xl md:text-5xl font-bold mt-3 max-w-3xl">
          Từ một video viral đến nội dung của bạn — 3 phút.
        </h2>
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-brand p-12 md:p-16 text-white shadow-glow">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-extrabold max-w-2xl">
            Đừng đoán nội dung nào sẽ viral. Hãy phân tích nó.
          </h2>
          <p className="mt-4 max-w-xl text-white/85">
            Dùng thử 7 ngày, không cần thẻ. Mở khoá Remix AI, voice profile và lịch 30 ngày ngay.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Link to="/dashboard">
              <Button
                size="lg"
                className="bg-white text-foreground hover:bg-white/90 h-12 px-6 gap-2"
              >
            ...
            <Link to="/pricing">
              <Button
                size="lg"
                variant="outline"
                className="border-white/40 text-white hover:bg-white/10 h-12 px-6 bg-transparent"
              >
                Xem giá
              </Button>
            </Link>
